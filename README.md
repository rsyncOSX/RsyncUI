...
![GitHub Releases](https://img.shields.io/github/downloads/rsyncosx/RsyncUI/v2.3.6/total)
...
|---------|---------------------|-----------------------------------------------------------------------------------------------------|
| RsyncUI | SwiftUI, declarativ | v2.3.6 - [7 March 2025](https://github.com/rsyncOSX/RsyncUI/releases) - in **active development** |
