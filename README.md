...
If you are on *macOS Sonoma* use RsyncUI. RsyncUI is under active development now and in the future.  There is also some info about [how the apps are built](https://rsyncui.netlify.app/post/built/). It is high level info only, most towards RsyncUI and SwiftUI, but you will get the idea. 
...
| ----------- | ----------- |   ----------- | -------- |  -------- | -------- |
| RsyncUI   | about 13.4k | 161  | SwiftUI, declarativ     | v1.8.2 - [8 Januart 2024](https://github.com/rsyncOSX/RsyncUI/releases)  | 6 May 2021  | 
...
[![GitHub license](https://img.shields.io/github/license/rsyncOSX/RsyncUI)](https://github.com/rsyncOSX/RsyncUI/blob/main/Licence.MD) ![GitHub Releases](https://img.shields.io/github/downloads/rsyncosx/RsyncUI/v1.8.2/total) ![GitHub Releases](https://img.shields.io/github/downloads/rsyncosx/RsyncUI/v1.8.1/total) [![Netlify Status](https://api.netlify.com/api/v1/badges/1d14d49b-ff14-4142-b135-771db071b58a/deploy-status)](https://app.netlify.com/sites/rsyncui/deploys) [![GitHub issues](https://img.shields.io/github/issues/rsyncOSX/RsyncUI)](https://github.com/rsyncOSX/RsyncUI/issues)
