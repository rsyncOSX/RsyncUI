...
Using refactored Swift Packages, still in testing. DO NOT USE.
...
| ----------- |   ----------- | ----------- |
| `brew install --cask rsyncui`    | macOS Sonoma and later | v2.7.8 - [November 19, 2025](https://github.com/rsyncOSX/RsyncUI/releases) - in *active development* |
