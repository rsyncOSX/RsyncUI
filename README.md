...
Next version (v1.2.4) will merge the two task views, multiple tasks and single task, into one view. There will probably be a new release later in December or early January.
