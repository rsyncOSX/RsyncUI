...
![GitHub Releases](https://img.shields.io/github/downloads/rsyncosx/RsyncUI/v2.8.7/total)
![GitHub Releases](https://img.shields.io/github/downloads/rsyncosx/RsyncUI/v2.8.6/total)
...
| ----------- |   ----------- | ----------- |
| `brew install --cask rsyncui`    | macOS Sonoma and later | v2.8.7 - [January 15, 2026](https://github.com/rsyncOSX/RsyncUI/releases) - in *active development* |
