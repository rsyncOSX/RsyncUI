        ...
        if let fullpathmacserial = path.fullpathmacserial {
            ...
            if let jsonData, let logrecordfileURL {
                do {
                    ...
                    Logger.process.info("WriteLogRecordsJSON - \(myprofile), privacy: .public): write logrecords to permanent storage MAIN THREAD: \(Thread.isMain, privacy: .public) but on \(Thread.current, privacy: .public)")
