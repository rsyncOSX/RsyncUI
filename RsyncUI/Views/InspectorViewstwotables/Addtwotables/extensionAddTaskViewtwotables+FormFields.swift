//
//  extensionAddTaskViewtwotables+FormFields.swift
//  RsyncUI
//
...
extension AddTaskViewtwotables {
    var synchronizeID: some View {
        Section(header: Text("Synchronize ID")
    ...
    var localandremotecatalog: some View {
        Section(header: Text("Folder parameters")
            .modifier(FixedTag(200, .leading))
            .font(.title3)
            .fontWeight(.bold)) {
    ...
    var remoteuserandserver: some View {
        Section(header: Text("Remote parameters")
            .modifier(FixedTag(200, .leading))
            .font(.title3)
            .fontWeight(.bold)) {
